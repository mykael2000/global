...
if (isset($_POST['yes'])) {
    $sqldel = "DELETE FROM shipments WHERE id = '$userid'";
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Globalexpresscourierltd Shipment Delete

        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Home</a></li>
            <li class="active">Delete Shipment</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Delete Shipment</h3>
                        <div class="box-tools">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>Are you sure you want to delete this shipment?</td>
                                <form action="" method="post">
                                    <td><a href="viewShipments.php" type="submit"
